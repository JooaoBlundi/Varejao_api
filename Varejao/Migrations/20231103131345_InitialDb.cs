        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantidade = table.Column<int>(type: "int", maxLength: 30, nullable: false),
                    PrecoVenda = table.Column<decimal>(type: "decimal(65,30)", maxLength: 30, nullable: false),
                    PrecoCusto = table.Column<decimal>(type: "decimal(65,30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cpf = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Cargo = table.Column<int>(type: "int", maxLength: 30, nullable: false),
